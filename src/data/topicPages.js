    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The Foundation’s awards programme does not operate a physical repository. It recognises exemplars of stewardship — practitioners, institutions, and open contributors whose work demonstrates how applied landscape architecture can be documented with integrity, retrieved by third parties, and cited in academic or institutional contexts without dependence on a single vendor stack.'
        ]
      },
      {
        ...
        paragraphs: [
          ...
          'Where entries involve reference data, tooling, or research, reviewers examine reproducibility and registry integrity: published schemas, test fixtures, validator rules, or study protocols that a third party could re-run; datasets with documented versioning and provenance chains; and crosswalks that map foreign property sets to Foundation fields with explicit loss notes. Cross-vendor interchange — for example, Revit, IFC, GIS, nursery, or council exchange profiles — is evaluated on fidelity of mapping and loss documentation, not on brand affiliation.',
      ...
      },
      {
        ...
        heading: 'Research',
        paragraphs: [
          'This category honours scholarship, studio pedagogy, and public programmes that treat open landscape metadata and the field registry as shared disciplinary infrastructure — not as a proprietary product feature — and that train practitioners in archival and documentation literacy.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Awards confer recognition, not accreditation. They are not a government endorsement, professional registration, or regulatory approval. Like the open specification and field registry, they exist so practitioners, researchers, and institutions can point to independently reviewed exemplars of applied landscape architecture, archival stewardship, and interchange discipline.'
        ],
        actions: [
