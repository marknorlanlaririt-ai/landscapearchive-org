...
export function buildFoundationIntendedPurposeSections() {
  return Object.freeze([
    ...
    },
    {
      ...
      paragraphs: [
        `The intended mission is to advance environmental and social benefit through open, citable infrastructure for honest landscape documentation — and, with it, a durable future for landscape architecture as a digitally documented discipline. Botanical authenticity, auditable climate disclosure, culturally protocol-aware metadata, and ethical synthetic-nature provenance are encoded in the public ${TLA185_DISPLAY_ID} / ${TLA169_DISPLAY_ID} specification: a shared vocabulary that makes project claims inspectable rather than implied.`,
