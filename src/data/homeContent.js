  ...
  return Object.freeze([
    {
      ...
      paragraphs: [
        ...
        'That work supports capacity building internationally among landscape architects, ecologists, BIM information managers, and allied professions — including the documenters, herbarium collaborators, Indigenous knowledge holders, and archival stewards whose labour often sits behind finished drawings and whose records must remain legible at handover — in teaching, research, procurement, and public-sector digital programmes. This is draft charitable scope for consultation; we do not claim incorporated charity status, active grant programmes, or humanitarian field operations.'
      ],
