  ...
  return Object.freeze([
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'That infrastructure is already partially in place. The specification is released on GitHub under semantic versioning; a schema portal allows browsing of modules without downloading the full dictionary; worked example bundles illustrate how sustainability and site context fields compose in real project records; and a reference validator supports structural and Foundation Approved checks in local or browser environments. Revit crosswalk documentation connects the open model to common delivery workflows. <a href="https://schema.landscapearchive.org/examples/built-environment/manifest.json">Built environment export profiles</a> — IFC property sets, civic GeoJSON, USD metadata sidecars, and nursery spreadsheet crosswalks — publish TLA-185 interchange bindings as draft/MVP schema artefacts with worked examples. Any party may inspect, cite, and teach these materials under the non-commercial licence terms — attributing the specification, refraining from redistributing modified copies, and implementing through their own tooling or a licensed vendor where commercial use is required.',
